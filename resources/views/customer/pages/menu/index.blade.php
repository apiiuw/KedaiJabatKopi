...
<div class="h-full min-h-screen flex flex-col items-center pt-28 md:pt-36 px-8">
    ...
    <div class="flex flex-row items-center gap-x-16 mt-0 md:mt-0 text-[#C4C2C2]">
        ...
        <a href="{{ route('customer.menu', ['category' => 'Food']) }}" 
        class="flex flex-col justify-end h-28 {{ $category === 'Food' ? 'text-white' : 'hover:text-white' }} items-center transition duration-300 ease-in-out">
            <i class="fa-solid fa-utensils fa-2xl"></i>
            <p class="text-lg md:text-2xl mt-5">The Food</p>
        </a>
        <a href="{{ route('customer.menu', ['category' => 'all']) }}" 
        class="flex flex-col justify-end h-28 {{ $category === 'all' || !$category ? 'text-white' : 'hover:text-white' }} items-center transition duration-300 ease-in-out">
