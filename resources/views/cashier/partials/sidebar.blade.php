...
<aside id="separator-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="flex flex-row justify-center items-center py-3 bg-gray-50">
   ...
   <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50">
      <ul class="space-y-2 font-medium">
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-greenJagat group">
         ...
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-greenJagat group">
               <i class="fa-solid fa-cart-shopping fa-lg shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900"></i>
      ...
      <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200">
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-greenJagat group">
               <i class="fa-solid fa-right-from-bracket fa-lg shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900"></i>
